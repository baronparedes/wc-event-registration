...
grant select on table public.attendance_fields to authenticated;
grant select on table public.attendance_answers to authenticated;
grant select on table public.attendance_walk_ins to authenticated;
grant select on table public.attendance_check_ins to authenticated;
grant select on table public.attendance_slot_records to authenticated;

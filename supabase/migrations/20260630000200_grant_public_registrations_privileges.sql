...
select
,
update on table public.public_registrations to anon;

-- Public attendees can insert/select their own answers
grant insert,
select
  on table public.public_registration_answers to anon;
...
,
  insert,
update,
delete on table public.public_registrations to authenticated;
...
,
  insert,
update,
delete on table public.public_registration_answers to authenticated;

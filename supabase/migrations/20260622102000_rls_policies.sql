...
-- ------------------------------------------------------------
create policy "public can read fields of published events"
...
-- ------------------------------------------------------------
create policy "admins can manage registration answers"
...
-- ------------------------------------------------------------
create policy "admins can manage import staging"
  on public.users_import_staging for all
  to authenticated
  using
(public.is_admin
())

...
grant
select
  on table public.event_fields to anon,
  authenticated;
...
,
  insert,
update,
delete on table public.admins to authenticated;
...
,
  insert,
update,
delete on table public.event_fields to authenticated;
...
,
  insert,
update,
delete on table public.registrations to authenticated;
...
,
  insert,
update,
delete on table public.registration_answers to authenticated;
...
,
  insert,
update,
delete on table public.users_import_staging to authenticated;
...
,
  insert,
update,
delete on table public.import_errors to authenticated;

...
with
    ...
    (
        select
            ...
            'attendance_answers', coalesce(attendance_answers.answers, '[]'
    ::jsonb),
...
grant
execute on function public.get_member_event_history (uuid) to authenticated;

grant
execute on function public.get_member_event_history (uuid) to service_role;

...
create type public.attendee_kind_v2 as enum('registered', 'public');

alter table public.attendance_check_ins
alter column attendee_kind type public.attendee_kind_v2 using attendee_kind::text::public.attendee_kind_v2;

drop type public.attendee_kind;

alter type public.attendee_kind_v2
rename to attendee_kind;

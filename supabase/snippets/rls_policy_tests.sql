...
where schemaname = 'public'
    and tablename in (
    'users', 'admins', 'events', 'event_fields',
    'registrations', 'registration_answers',
    'users_import_staging', 'import_errors'
  )
order by tablename;
...
begin;
    ...
    authenticated;
set local "request.jwt.claims"
to '{"sub": "00000000-0000-0000-0000-000000000099", "role": "authenticated"}';
...
begin;
    ...
    values
        ('aaaaaaaa-0000-0000-0000-000000000001', 'pub', 'Published', 'published'),
        ('aaaaaaaa-0000-0000-0000-000000000002', 'drft', 'Draft', 'draft');

    insert into public.event_fields
        (event_id, field_key, label, field_type)
    values
        ('aaaaaaaa-0000-0000-0000-000000000001', 'name', 'Name', 'text'),
        ('aaaaaaaa-0000-0000-0000-000000000002', 'secret', 'Secret', 'text');

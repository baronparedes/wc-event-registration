...
- **Unregistered Members CSV Export Scope**: CSV export from the unregistered members report always includes the full event-level unregistered set, independent of current search filters and pagination state

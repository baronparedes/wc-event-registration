Feature: View Registration Details
  ...
  Context: Business Rules
    ...
    - Actions available based on status: Cancel (if active) and Reactivate (if cancelled)
  ...
  Scenario: See registration action buttons
    ...
    When the page loads
    Then I see status-based action buttons:
  ...
  Scenario: Navigate back to registrations list
    ...
    And I can continue managing registrations from the list

...
export function FormTextareaField(props: FormTextareaFieldProps) {
  ...
  return (
    <div className="space-y-1.5">
      ...
      <textarea
        {...registration}
        className={`min-h-28 w-full rounded-md border bg-background px-3.5 py-2.5 text-sm leading-6 text-text focus:outline-none focus:ring-2 disabled:cursor-not-allowed disabled:bg-gray-100 disabled:text-gray-600 ${
          error
